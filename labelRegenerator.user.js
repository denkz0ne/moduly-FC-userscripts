    ...
    if (wrapper) {
        ...
        if (vpText && vpText.previousSibling && vpText.previousSibling.textContent.trim() === 'VP') {
            ...
            if (window.TM_top) {
                ...
                topSpan.title = String(window.TM_top);
                topSpan.textContent = window.TM_top;
                topSpan.style.cssText = 'background:#000;color:#fff;border:1px solid #000;padding:1px 5px;margin-left:6px;border-radius:6px;display:inline-block;vertical-align:middle;';
