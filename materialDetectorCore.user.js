// ==UserScript==
// @name         materialDetector Core
// @namespace    https://moduly.faxcopy.sk/
// @author       mato e.
// @version      3.2.8
// @description  Zistovanie rozmeru/materialu a datumu expedicie pre stitok.
// @updateURL    https://github.com/denkz0ne/moduly-FC-userscripts/raw/main/materialDetectorCore.user.js
// @downloadURL  https://github.com/denkz0ne/moduly-FC-userscripts/raw/main/materialDetectorCore.user.js
...
(function () {
    ...
    function parse41tvDetailsFromZd(params) {
        ...
        if (normalizedPrintType.includes('fareb')) {
            colorCode = 'f';
        } else if (normalizedPrintType.includes('ciernobiel') || normalizedPrintType.includes('ciernobiela') || normalizedPrintType.includes('ciernobiely') || normalizedPrintType.includes('cb')) {
            colorCode = 'cb';
        }
